#ifndef _SECP256K1_ECIES_H
# define _SECP256K1_ECIES_H
 ...
 *           a_ell64:       printer to 64 bytes of an encoded eliptic curve point(See ellsq). Alice's ELLSQ encoded public elptic curve point.
 *  In:      plain:           pointer to 32 bytes of message data 
 *           rnd32:         pointer to 32 bytes of entropy (must be unpredictable). Alice's private key.
 ...
 *           rnd32:         pointer to 32 bytes of entropy (must be unpredictable). Bob's private key.
