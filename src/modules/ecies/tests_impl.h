...
#ifndef _SECP256K1_MODULE_ECIES_TEST_H
#define _SECP256K1_MODULE_ECIES_TEST_H
...
void run_ecies_tests(void) {
    ...
    /*Prepare Alice's ellsq private key.*/
    ...
    secp256k1_ellswift_encode(ctx, b_ell64, &b_pubkey, b_ell_rnd32);
    ...
    /*Decrypt*/
   	secp256k1_ecies_decrypt(ctx, remsg, crypt, 32, b_rnd32, b_ell64, a_ell64);
